...
let add pfn rfn alloc free devm_alloc file rule =
   ...
   (match rule with
    ...
    | UseFinalMerge -> it#add_virtual_rule Finalmerge);
...
@remge depends on !finalmerge exists@
identifier virtual.rfn, virtual.free;
identifier y;
identifier pdev;
@@
...
@remg depends on remge && !finalmerge@
identifier virtual.rfn, virtual.free;
identifier y;
identifier pdev;
position p3;
